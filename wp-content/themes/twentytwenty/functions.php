...
function tw_woocommerce_short_description($description){
    return strtoupper($description);
}
add_filter('woocommerce_short_description','tw_woocommerce_short_description');


function tw_woocommerce_product_tabs($tabs){
    $tabs[]= [
            'title'=>__('New Tab','twentytwenty'),
            'priority'=>20,
            'callback'=>'new_tab_description'
    ];

    return $tabs;
}
add_filter('woocommerce_product_tabs','tw_woocommerce_product_tabs');


function new_tab_description(){
    echo 'This is new tab description';
}
